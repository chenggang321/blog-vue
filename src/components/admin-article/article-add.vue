    ...
    <div>
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input v-model="form.description" type="text" class="form-control" id="description" placeholder="请输入内容简介" name="description">
        </div>
        <div class="form-group">
          <label for="img_url">图片链接：</label>
          <input v-model="form.img_url" type="text" class="form-control" id="img_url" placeholder="请输入图片链接" name="img_url">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea v-model="form.content" name="content" id="editor" class="form-control" rows="10" placeholder="请输入内容"></textarea>
        </div>
